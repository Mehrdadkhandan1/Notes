...
const AddTodo = () => {
  ...
  const submitedForm = (e) => {
    ...
    if (dataTodo.noteId !== undefined && dataTodo.noteId !== null) {
      requestData.noteId = dataTodo.noteId;
    }
    if (dataTodo.isCompleted !== undefined && dataTodo.isCompleted !== null) {
      requestData.isCompleted = dataTodo.isCompleted;
    }

    axios
      .post("/api/addTodo", requestData)
      .then((resp) => {
        console.log(resp);
        if (resp.status === 201) {
